...
public abstract class ListTest {
    ...
    /**
     * Tests addRightFront when left and right are both empty.
     */
    @Test
    ...
    /**
     * Tests addRightFront when left is empty and right isn't empty.
     */
    @Test
    ...
    /**
     * Tests addRightFront when left isn't empty and right is empty.
     */
    @Test
    public final void testAddRightFrontLeftNonEmptyRightEmpty() {
         ...
         * Set up variables
         */
        final int lastLeft = 3;
        List<String> list1 = this.createFromArgsTest(lastLeft, "yellow",
                "orange", "purple");
        List<String> list2 = this.createFromArgsRef(lastLeft, "yellow",
                "orange", "purple", "red");
        /*
         * Call method under test
         */
    ...
    /**
     * Tests addRightFront when left and right are both not empty.
     */
    @Test
    ...
    /**
     * Tests removeRightFront when the left list is empty and the right list has
     * 1 item.
     */
    @Test
    ...
    /**
     * Tests removeRightFront when the left list is empty and the right list
     * isn't empty.
     */
    @Test
    ...
    /**
     * Tests removeRightFront when the left list isn't empty and the right list
     * has 1 item.
     */
    @Test
    ...
    /**
     * Tests advance when the left list is empty and the right list has one
     * item.
     */
    @Test
    ...
    /**
     * Tests advance when the left list is empty and the right list isn't empty.
     */
    @Test
    ...
    /**
     * Tests advance when the left list isn't empty and the right list has one
     * item.
     */
    @Test
    public final void testAdvanceLeftNonEmptyRightOne() {
         ...
         */
        final int lastLeft = 3;
        final int lastLeftExpected = 4;
        List<String> list1 = this.createFromArgsTest(lastLeft, "yellow",
                "orange", "purple", "red");
        List<String> list2 = this.createFromArgsRef(lastLeftExpected, "yellow",
                "orange", "purple", "red");
        /*
         * Call method under test
         */
    ...
    /**
     * Tests advance when the left list isn't empty and the right list isn't
     * empty.
     */
    @Test
    ...
    /**
     * Tests moveToStart when the left list is empty and the right list is
     * empty.
     */
    @Test
    ...
    /**
     * Tests moveToStart when the left list is empty and the right list isn't
     * empty.
     */
    @Test
    ...
    /**
     * Tests moveToStart when the left list isn't empty and the right list is
     * empty.
     */
    @Test
    ...
    /**
     * Tests moveToStart when the left list isn't empty and the right list isn't
     * empty.
     */
    @Test
    ...
    /**
     * Tests rightLength when the left list is empty and the right list is
     * empty.
     */
    @Test
    ...
    /**
     * Tests rightLength when the left list is empty and the right list isn't
     * empty.
     */
    @Test
    ...
    /**
     * Tests rightLength when the left list isn't empty and the right list is
     * empty.
     */
    @Test
    ...
    /**
     * Tests rightLength when the left list isn't empty and the right list isn't
     * empty.
     */
    @Test
    ...
    /**
     * Tests leftLength when the left list is empty and the right list is empty.
     */
    @Test
    ...
    /**
     * Tests leftLength when the left list is empty and the right list isn't
     * empty.
     */
    @Test
    ...
    /**
     * Tests leftLength when the left list isn't empty and the right list is
     * empty.
     */
    @Test
    ...
    /**
     * Tests leftLength when the left list isn't empty and the right list isn't
     * empty.
     */
    @Test
    ...
    /**
     * Tests iterator on a list that only has items in its right list.
     */
    @Test
    ...
    /**
     * Tests iterator on a list that only has items in its left list.
     */
    @Test
    public final void testIteratorOnlyLeft() {
         ...
         */
        final int lastLeft = 3;
        List<String> list1 = this.createFromArgsTest(lastLeft, "red", "green",
                "blue");
        List<String> list2 = this.createFromArgsRef(0);
        List<String> list3 = this.createFromArgsRef(lastLeft, "red", "green",
                "blue");
    ...
    /**
     * Tests iterator on a list that has items in its left and right lists.
     */
    @Test
    ...
    /**
     * Tests moveToFinish when the left list is empty and the right list is
     * empty.
     */
    @Test
    ...
    /**
     * Tests moveToFinish when the left list is empty and the right list isn't
     * empty.
     */
    @Test
    public final void testMoveToFinishLeftEmptyRightNonEmpty() {
        ...
        final int lastLeft = 3;
        List<String> list1 = this.createFromArgsTest(0, "green", "red", "blue");
        List<String> list2 = this.createFromArgsRef(lastLeft, "green", "red",
                "blue");
        /*
         * Call method under test
         */
    ...
    /**
     * Tests moveToFinish when the left list isn't empty and the right list is
     * empty.
     */
    @Test
    ...
    /**
     * Tests moveToFinish when the left list isn't empty and the right list
     * isn't empty.
     */
    @Test
    public final void testMoveToFinishLeftNonEmptyRightNonEmpty() {
         ...
         * Set up variables
         */
        final int list2LastLeft = 4;
        List<String> list1 = this.createFromArgsTest(2, "yellow", "orange",
                "green", "purple");
        List<String> list2 = this.createFromArgsRef(list2LastLeft, "yellow",
                "orange", "green", "purple");
        /*
         * Call method under test
         */
    ...
    /**
     * Tests moveToFinish before calling addRightFront.
     */
    @Test
    ...
    /**
     * Tests retreat when the left list is empty and the right list has one
     * item.
     */
    @Test
    public final void testRetreatLeftEmptyRightOne() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "reed");
        List<String> list2 = this.createFromArgsRef(0, "reed");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    /**
     * Tests retreat when the left list isn't empty and the right list is empty.
     */
    @Test
    public final void testRetreatLeftNonEmptyRightEmpty() {
         ...
         * Set up variables
         */
        final int list1LastLeft = 3;
        List<String> list1 = this.createFromArgsTest(list1LastLeft, "grass",
                "dirt", "sand");
        List<String> list2 = this.createFromArgsRef(2, "grass", "dirt", "sand");
        /*
         * Call method under test
         */
        list1.retreat();
    ...
    /**
     * Tests retreat when the left list has 1 item and the right list isn't
     * empty.
     */
    @Test
    public final void testRetreatLeftOneRightNonEmpty() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "Drake", "Kanye West",
                "J. Cole", "Kendrick Lamar");
        List<String> list2 = this.createFromArgsRef(0, "Drake", "Kanye West",
                "J. Cole", "Kendrick Lamar");
        /*
         * Call method under test
         */
    ...
    /**
     * Tests retreat when the left list isn't empty and the right list isn't
     * empty.
     */
    @Test
    public final void testRetreatLeftNonEmptyRightNonEmpty() {
         ...
         */
        final int list1LastLeft = 3;
        List<String> list1 = this.createFromArgsTest(list1LastLeft, "CSE",
                "ECE", "ISE", "BME");
        List<String> list2 = this.createFromArgsRef(2, "CSE", "ECE", "ISE",
                "BME");
        /*
         * Call method under test
         */
