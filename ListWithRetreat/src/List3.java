...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        /*
         * Set preStart and lastLeft to the same node and postFinish to another
         * node
         */
        ...
        /*
         * Set the next of lastLeft to postFinish and the previous of postFinish
         * to lastLeft
         */
        this.lastLeft.next = this.postFinish;
        this.postFinish.previous = this.lastLeft;
        // Initialize lengths of left and right lists to 0
        this.leftLength = 0;
        this.rightLength = 0;
    }
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * Store in variables the node to add, and the nodes to the left and
         * right of it.
         */
        Node left = this.lastLeft;
        Node newNode = new Node();
        Node right = this.lastLeft.next;
        // Set the new node's data to x
        newNode.data = x;
        // Link left and newNode with previous and next respectively
        left.next = newNode;
        newNode.previous = left;
        // Link newNode and right with previous and next respectively
        newNode.next = right;
        right.previous = newNode;
        // Increase length of right list by 1 after adding new item
        this.rightLength++;
    ...
    public final T removeRightFront() {
        ...
        // Store data from node to be removed
        T data = this.lastLeft.next.data;
        // Store nodes on the left and right of node to be removed in variables
        Node left = this.lastLeft;
        Node right = this.lastLeft.next.next;
        // Link left and right nodes to each other
        left.next = right;
        right.previous = left;
        // Decrease length of right list by 1 after item is removed
        this.rightLength--;

        assert this.conventionHolds();
        // Return data from the node that was removed
        return data;
    }
    ...
    public final void advance() {
        assert this.rightLength() > 0 : "Violation of: this.right /= <>";
        /*
         * Set lastLeft to the first item of the right list, increase left list
         * length by 1 and decrease right list length by 1
         */
    ...
    public final void moveToStart() {
        /*
         * Set lastLeft to the first item of list, add left list length to right
         * list length, set left list length to 0
         */
        this.lastLeft = this.preStart;
    ...
    public final void moveToFinish() {
        /*
         * Set lastLeft to the last item in the right list, add length of right
         * list to length of left list, set length of right list to 0.
         */
    ...
    public final void retreat() {
        ...
        /*
         * Set lastLeft to the node before it, decrease the length of left list
         * by 1, increase the length of right list by 1.
         */
