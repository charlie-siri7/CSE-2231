...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        ...
        // Creates unnamed program with empty context and body
        this.name = "Unnamed";
    ...
    public final void setName(String n) {
        ...
        // Sets name of program to input n
        this.name = n;
    }
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        /*
         * Swaps context of program with the map parameter using a temporary map
         * to store the program's context
         */
    ...
    public final Statement newBody() {
        ...
        // Returns an empty statement to use as a body
    ...
    public final void swapBody(Statement b) {
        ...
        /*
         * Swaps body with the statement parameter using a temporary statement
         * to store the program's body
         */
