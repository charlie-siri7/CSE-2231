...
public abstract class StatementTest {
    ...
    /**
     * The name of another file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_2 = "data/statement-sample2.bl";

    /**
     * The name of yet another file containing a sequence of BL statements.
     */
    ...
    public final void testKindCall() {
        ...
        Statement sourceTest = this.createFromFileTest(FILE_NAME_1);
        Statement sourceRef = this.createFromFileRef(FILE_NAME_1);
        Statement sTest = sourceTest.removeFromBlock(call);
        Statement sRef = sourceRef.removeFromBlock(call);
        Kind kRef = sRef.kind();
    ...
    /**
     * Test kind of a WHILE statement for another input file.
     */
    @Test
    ...
    /**
     * Test addToBlock at an interior position for another input file.
     */
    @Test
    ...
    /**
     * Test removeFromBlock at the front leaving a non-empty block behind for
     * another input file.
     */
    @Test
    ...
    /**
     * Test lengthOfBlock, greater than zero for another input file.
     */
    @Test
    ...
    /**
     * Test assembleIf for another input file.
     */
    @Test
    ...
    /**
     * Test disassembleIf for another input file.
     */
    @Test
    ...
    /**
     * Test assembleIfElse for another input file.
     */
    @Test
    ...
    /**
     * Test disassembleIfElse for another input file.
     */
    @Test
    ...
    /**
     * Test assembleWhile for another input file.
     */
    @Test
    ...
    /**
     * Test disassembleWhile for another input file.
     */
    @Test
    ...
    /**
     * Test assembleCall for another input.
     */
    @Test
    ...
    /**
     * Test disassembleCall for another input file.
     */
    @Test
    public final void testDisassembleCall2() {
        ...
        Statement blockTest = this.createFromFileTest(FILE_NAME_2);
        Statement blockRef = this.createFromFileRef(FILE_NAME_2);
        Statement sTest = blockTest.removeFromBlock(index);
        Statement sRef = blockRef.removeFromBlock(index);
        String nRef = sRef.disassembleCall();
    ...
    /**
     * Test kind of an if statement for another input file.
     */
    @Test
    ...
    /**
     * Test kind of a if-else statement for another input file.
     */
    @Test
    ...
    /**
     * Test kind of a call for another input file.
     */
    @Test
    ...
    public final void testAssembleIf3() {
        ...
        Statement emptyBlock = blockRef.newInstance();
        Statement sourceTest = blockTest.removeFromBlock(index);
        Statement sRef = blockRef.removeFromBlock(index);
        Statement nestedTest = sourceTest.newInstance();
        Condition c = sourceTest.disassembleIf(nestedTest);
        Statement sTest = sourceTest.newInstance();
    ...
    public final void testAssembleWhile3() {
        ...
        Statement emptyBlock = blockRef.newInstance();
        Statement sourceTest = blockTest.removeFromBlock(index);
        Statement sourceRef = blockRef.removeFromBlock(index);
        Statement nestedTest = sourceTest.newInstance();
        Statement nestedRef = sourceRef.newInstance();
        Condition cTest = sourceTest.disassembleIf(nestedTest);
        Condition cRef = sourceRef.disassembleIf(nestedRef);
     ...
     */
    @Test
    public final void testKindIfElse3() {
        /*
         * Setup
         */
        final int ifElsePos = 2;
     ...
     */
    @Test
    public final void testKindCall3() {
        /*
         * Setup
         */
        final int call = 0;
